...
ColorSpace::Rgb InterpolateInRGB(const ColorSpace::Rgb& ColorA, const ColorSpace::Rgb& ColorB,
    ...
    //InterpolatedColor.r = (1-t)*ColorA.r;  // ColorA.r;
    //InterpolatedColor.g = t * ColorB.g;
    //InterpolatedColor.b = (1-t)*ColorA.b;  //ColorA.b;

    InterpolatedColor.r = (1 - t) * ColorA.r + t * ColorB.r;  // ColorA.r;
    InterpolatedColor.g = (1 - t) * ColorA.g + t * ColorB.g; // ColorA.g;
    InterpolatedColor.b = (1 - t) * ColorA.b + t * ColorB.b; // ColorA.b;
...
ColorSpace::Cmyk InterpolateInCMYK(const ColorSpace::Cmyk& ColorA, const ColorSpace::Cmyk& ColorB,
    ...
    InterpolatedColor.c = (1 - t) * ColorA.c + t * ColorB.c;  // cyan component of the color space
    InterpolatedColor.m = (1 - t) * ColorA.m + t * ColorB.m;  // magenta component of the color space
    InterpolatedColor.y = (1 - t) * ColorA.y + t * ColorB.y;  // yellow component of the color space
    InterpolatedColor.k = (1 - t) * ColorA.k + t * ColorB.k;  // black component of the color space
...
ColorSpace::Hsv InterpolateInHSV(const ColorSpace::Hsv& ColorA, const ColorSpace::Hsv& ColorB,
    ...
    InterpolatedColor.h = ((1 - t) * ColorA.h + t*ColorB.h)*360;
...
ColorSpace::Hsv ChangeValueAndSaturation(const ColorSpace::Hsv& Color, const float tValue,
    ...
    ChangedColor.h = Color.h; //hue has not to be change, therefore we pass the h component of color
    ChangedColor.s = Color.s*tSaturation; //saturation is changed, we pass the value
    ChangedColor.v = Color.v*tValue; //value is changed, we pass the value
...
ColorSpace::Hsv ChangeHueAndSaturation(const ColorSpace::Hsv& Color, const float tHue,
    ...
    ChangedColor.h = Color.h*tHue*360; //we multiply by 360 because the value given by tHue is between 0 and 1
    ChangedColor.s = Color.s*tSaturation;
